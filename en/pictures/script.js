...
/* harmony import */ var _modules_showMoreStylesFromServer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/showMoreStylesFromServer */ "./src/js/modules/showMoreStylesFromServer.js");
...
/* harmony import */ var _modules_showImage__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/showImage */ "./src/js/modules/showImage.js");
...
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/scroll */ "./src/js/modules/scroll.js");
/* harmony import */ var _modules_scrolling_reqAnimFrame__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/scrolling-reqAnimFrame */ "./src/js/modules/scrolling-reqAnimFrame.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(imageState);
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])("[name='phone']");
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row > div'); // showMoreStylesFromServer('.button-styles', '.styles > .container > .row');

  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_7__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', imageState);
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_modules_showImage__WEBPACK_IMPORTED_MODULE_9__["default"])();
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_10__["default"])('.accordion-heading', '.accordion-block');
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_11__["default"])('.burger-menu', '.burger'); // scroll();
  // scrolling('[href="#footer"]');

  Object(_modules_scrolling_reqAnimFrame__WEBPACK_IMPORTED_MODULE_13__["default"])('.pageup');
  ...
  btns.forEach(function (btn, i) {
    btn.addEventListener('click', function () {
      ...
      btns.forEach(function (btn, j) {
        if (i === j && btns[i].classList.contains('active-style')) return;
...
var calc = function calc(size, material, options, promocode, result, state) {
  ...
  materialBlock.addEventListener('change', function (e) {
    ...
    state['materialValue'] = materialValue;
    calcSum();
  });
  optionsBlock.addEventListener('change', function () {
    optionsValue = this.value;
  ...
  function calcSum() {
    if (+sizeValue && +materialValue) {
      ...
      promo == 'IWANTPOPART' ? sum = Math.round(sum * 0.7) : null;
      resultBlock.innerHTML = sum;
    } else {
      resultBlock.innerHTML = 'To calculate you need to choose the size of the painting and the material of the painting';
    }
  }
};
...
var checkTextInputs = function checkTextInputs(selector) {
  ...
  txtInputs.forEach(function (input) {
    input.addEventListener('input', function (e) {
      if (/[а-яё]/ig.test(e.target.value)) {
        e.target.value = '';
      }
    });
...
var drop = function drop() {
  ...
  // dragstart *
  // drop - кнопка мыши отпущена и объект упал над dropArea
  // * - срабатывают на элементе, который перетаскивают (не подходит для перетаскивания файлов из файловой системы)
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      if (input.closest('.main')) {
        Object(_services_request__WEBPACK_IMPORTED_MODULE_3__["postData"])('assets/server.php', data).then(function (res) {
...
var filter = function filter() {
  ...
  items.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      var flag = false;
      getComputedStyle(noBlock).display;
      blocks.forEach(function (block) {
        block.style.display = 'none';
        block.classList.remove('animated', 'fadeIn'); // getComputedStyle(block).display
        // if (!block.classList.contains(clazz)) {
        //   block.style.display = 'none';
        // } else {
      ...
      blocks.forEach(function (block) {
        if (block.classList.contains(clazz)) {
          requestAnimationFrame(function () {
            // позволяет дождаться выполнение block.style.display = 'none'; 
            block.style.display = 'block';
            block.classList.add('animated', 'fadeIn');
            console.log(1);
          }); // block.style.display = 'block';
...
/***/ "./src/js/modules/scrolling-reqAnimFrame.js":
/*!**************************************************!*\
  !*** ./src/js/modules/scrolling-reqAnimFrame.js ***!
  \**************************************************/
/*! exports provided: default */
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (e) {
      ...
      var widthTop = document.documentElement.scrollTop,
          // уже пройденный скролл страницы
      hash = this.hash,
          toBlock = document.querySelector(hash).getBoundingClientRect().top,
          // возвращает объект с параметрами элемента : отступ от верха, ширину, высоту, x/y координаты; .top дает только отступ от верха
      start = null; // console.log('ToBlock == '+toBlock);
      // console.log('ScrollTop == '+widthTop);

      requestAnimationFrame(step); // при вызове автоматически передается некоторое время в милисекундах, которое увеличивается с каждым вызовом raf;
      ...
      function step(time) {
        ...
        var progress = time - start,
            // считаем разницу между текущим временем и начальным
        r = toBlock < 0 ? Math.max(widthTop - progress / speed, widthTop + toBlock) : Math.min(widthTop + progress / speed, widthTop + toBlock); // Math.max() первым аргументом записана формула, основанная на скролле и делением разницы времени на скорость. когда этот аргумент будет меньше нуля, то вернется widthTop + toBlock, которое равно 0; Math.min() делает тоже самое, но для элементов, которые находятся ниже ссылки
        //  console.log('Math.min(widthTop + progress/speed+500, widthTop + toBlock)) = '+ Math.min(widthTop + progress/speed+500, widthTop + toBlock));
        // console.log('Progress == '+progress)
        // console.log('WidthTop == '+widthTop)
        // if (toBlock < 0){
        //   console.log('widthTop - progress/speed == '+(widthTop - progress/speed))
        // } else {
        //   console.log('widthTop + progress/speed == '+(widthTop + progress/speed))
        // }
        ...
        if (r != widthTop + toBlock) {
          // когда Math.max или Math.min возвращают widthTop + toBlock, raf больше не вызывается
...
var showImage = function showImage() {
  var images = document.querySelectorAll('.sizes-block');
  var arr = [];
  images.forEach(function (item) {
    arr.push(item.querySelector('img').getAttribute('src'));
  });
  images.forEach(function (item, i) {
    var img = item.querySelector('img');
    item.addEventListener('mousemove', function () {
      for (var j = 0; j < item.children.length; j++) {
        if (item.children[j].tagName == 'IMG' || item.children[j].classList.contains('sizes-hit')) continue;
        item.children[j].style.display = 'none';
      }

      img.src = "assets/img/sizes-".concat(i + 1, "-1.png");
    });
    item.addEventListener('mouseleave', function () {
      img.src = arr[i];

      for (var j = 0; j < item.children.length; j++) {
        item.children[j].style.display = 'block';
      }
    });
  });
};
...
/***/ "./src/js/modules/showMoreStylesFromServer.js":
/*!****************************************************!*\
  !*** ./src/js/modules/showMoreStylesFromServer.js ***!
  \****************************************************/
/*! exports provided: default */
...
var showMoreStylesFromServer = function showMoreStylesFromServer(trigger, selector) {
  var btn = document.querySelector(trigger);
    ...
    return regeneratorRuntime.async(function getData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(fetch('http://localhost:3000/styles'));
    ...
    return regeneratorRuntime.async(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return regeneratorRuntime.awrap(getData().then(function (data) {
              return data;
            }));
          ...
          case 2:
            ...
            data.forEach(function (item) {
              ...
              card.classList.add('col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1', 'animated', 'fadeInUp');
              card.innerHTML = "\n        <div class='styles-block'>\n          <img src=".concat(item.src, " alt=").concat(item.title, ">\n          <h4>").concat(item.title, "</h4>\n          <a href=").concat(item.link, ">In more detail</a>\n        </div>\n      ");
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreStylesFromServer);
