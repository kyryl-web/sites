...
var calc = function calc(size, material, options, promocode, result, state) {
  ...
  function calcSum() {
    if (+sizeValue && +materialValue) {
      ...
      resultBlock.innerHTML = 'Для розрахунку потрібно обрати розмір  картини і матеріал картини';
    }
  }
};
